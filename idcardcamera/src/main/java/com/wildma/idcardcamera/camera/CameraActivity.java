...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    public final static int    TYPE_PMI      = 1;             //button PMI
    public final static int    TYPE_FERRITE       = 2;        //button 铁素体
    public final static int    TYPE_HARDNESS              = 3;//button 硬度
...
//            maxSize = screenMinSize / 3.0f * 4.0f;
//            System.out.println(screenMinSize);
//        }
        ...
        else if(mType==TYPE_FERRITE){
            width = (int) (screenMinSize * 0.75);
            height = (int) (width / 3.0f * 4.0f);
        }
        else if(mType==TYPE_HARDNESS){
            width = (int) (screenMinSize*0.9 );
            height = (int) (width / 2.0f * 1.0f);
        }
        else{
            width = (int) (screenMinSize );
            height = (int) (width / 2.0f * 1.0f);
        }

//        float width = (int) (screenMinSize );
//        float height = (int) (width / 2.0f * 1.0f);
        ...
        mCropImageView.crop(new CropListener() {
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == TYPE_PMI) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append(""+date+".jpg").toString();
                    } else if (mType == TYPE_FERRITE) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append(""+date+".jpg").toString();
                    }else if (mType == TYPE_HARDNESS) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append(""+date+".jpg").toString();
